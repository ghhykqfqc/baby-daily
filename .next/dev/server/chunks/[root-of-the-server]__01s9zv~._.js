...
"[project]/pages/api/feedings.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('feedings').select('*').eq('baby_id', babyId).order('timestamp', {
            ascending: false
        });
        if (error) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('feedings').insert([
            {
                baby_id: babyId,
                type,
                volume,
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('feedings').update({
            type,
            volume,
            time,
            timestamp,
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('feedings').delete().eq('id', id);
        if (error) {
            return res.status(500).json({
                error: error.message
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01s9zv~._.js.map