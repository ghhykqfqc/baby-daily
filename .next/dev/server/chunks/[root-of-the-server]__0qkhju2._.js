...
"[project]/pages/api/growth.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('growth').select('*').eq('baby_id', babyId).order('timestamp', {
            ascending: false
        });
        if (error) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('growth').insert([
            {
                baby_id: babyId,
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('growth').update({
            weight: String(weight),
            height: String(height),
            date,
            timestamp
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabaseClient$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].from('growth').delete().eq('id', id);
        if (error) {
            return res.status(500).json({
                error: error.message
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0qkhju2._.js.map